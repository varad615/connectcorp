    ...
    <>
      <div>
        <section class="min-h-screen flex items-stretch text-white ">
          <div class="lg:flex w-1/2 hidden bg-no-repeat bg-cover relative items-center bg-gradient-to-b from-purple-800 to-indigo-800">
          ...
          <div class="lg:w-1/2 md:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
