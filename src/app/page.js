          ...
          <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <header class="text-gray-600 body-font">
              <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <span class="self-center text-3xl font-bold whitespace-nowrap text-[#7C3AED]">
                  ConnectCorp
                </span>
            ...
            <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
              <div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
                <h1 class="text-[#7C3AED] leading-relaxed mb-8 text-4xl font-bold sm:text-5xl md:mb-12 md:text-6xl">
                  Find your perfect candidate now
                </h1>

                <p class="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">
                  Search for a best candidate which can make your work easy
                </p>
              ...
              <div class="overflow-hidden rounded-lg bg-white lg:h-auto xl:w-5/12">
                <img
                  src="recruit.png"
                  loading="lazy"
        ...
        <div class="bg-gray-900">
          <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div class="border-t border-gray-800 py-8 text-center text-sm text-gray-400">
              © 2021 - Present Varad. All rights reserved.
            </div>
          </footer>
        </div>
      </div>
